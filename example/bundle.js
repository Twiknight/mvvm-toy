...
/***/ function(module, exports, __webpack_require__) {
	...
	var _hyperscriptHelpers = __webpack_require__(1);
	...
	var _helper = (0, _hyperscriptHelpers2.default)(_virtualDom.h);

	var div = _helper.div;
	var label = _helper.label;
	...
	var model = {
	  tpml: function tpml(x) {
	    return 'hello ' + x + ' !';
	  },
	  name: ''
	};

	var viewModel = function viewModel(model, notify) {
	  return {
	...
	var view = function view(vm) {
	  return div([label({ textContent: 'Name: ' }), input({ type: 'text', value: vm.name, oninput: vm.oninput }), hr(), h1({ textContent: vm.msg })]);
	};

	(0, _index2.default)('#app', { model: model, view: view, viewModel: viewModel });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var render = function render(root, left, right) {
	  (0, _virtualDom.patch)(root, (0, _virtualDom.diff)(left, right));
	};
	...
	*/
	function run(rootSelector, _ref) {
	  var model = _ref.model;
	  var view = _ref.view;
	  var viewModel = _ref.viewModel;

	  var left = (0, _virtualDom.h)('div');
	  var right = void 0;
	  var root = (0, _virtualDom.create)(left);
